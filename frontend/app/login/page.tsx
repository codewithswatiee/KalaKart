    ...
    <div className="min-h-screen bg-[#FFF0D1] flex flex-col items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-white">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="role" className="text-[#795757]">Role</Label>
            <Select>
              <SelectTrigger id="role" className="border-[#664343]">
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <p className="text-sm text-center text-[#664343]">
            ...
            <Link href="/signup" className="text-[#795757] hover:underline">
              Sign up
            </Link>
          </p>
        </CardFooter>
